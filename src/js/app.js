...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name || "Layla"} ${variables.lastName ||
    "Nasser"}</h1>
          <h2>${variables.role ? variables.role : "Web Developer"}</h2>
          <h3>${variables.country ? variables.country : "ESPAÑA"}, ${
    variables.city ? variables.city : "Tenerife"
  }</h3>
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://instagram.com/${
              variables.instagram ? variables.instagram : "nass.me___"
